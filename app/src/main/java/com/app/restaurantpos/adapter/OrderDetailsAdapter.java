...
public class OrderDetailsAdapter extends RecyclerView.Adapter<OrderDetailsAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        databaseAccess.open();
        holder.txtProductName.setText(databaseAccess.getProductName(orderData.get(position).get("product_name")));
        databaseAccess.close();

        holder.txtProductQty.setText("الكمية:"+ orderData.get(position).get("product_qty"));
        holder.txtProductWeight.setText("الوحدة" + orderData.get(position).get("product_weight"));
        databaseAccess.open();
        ...
        holder.txtTotalCost.setText(  unitPrice + " x " + qty + " = "  + cost);
