...
public class OrdersActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getCustomerId = getIntent().getExtras().getString("cust_id");
        ...
        if(getCustomerId.length()>=1) {
            orderList = databaseAccess.getOrderList(getCustomerId);
        }
        else{
        ...
        if (orderList.isEmpty()) {
            ...
            OrderAdapter orderAdapter = new OrderAdapter(OrdersActivity.this, orderList,api);
        ...
        etxtSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (searchOrder.isEmpty()) {
                    ...
                    OrderAdapter supplierAdapter = new OrderAdapter(OrdersActivity.this, searchOrder,api);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.menu_cart_button2) {
