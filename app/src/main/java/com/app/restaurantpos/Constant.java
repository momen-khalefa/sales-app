...
public class Constant {
    ...
    public static final String ORDER_RECEIPT="طلبية";
    ...
    public static String ttime="00:00:00";

    public static BluetoothDevice btDev=null;


    public static boolean checkPairedDevices(BluetoothDevice dev)
    {
        ...
        while(iter.hasNext())
        {
            ...
            if(bluetoothPort.isValidAddress(pairedDevice.getAddress()))
            {
                ...
                {
                    if(dev!=null) {
                        if (pairedDevice.getAddress().equals(dev.getAddress())) {
                            return true;
                        }
                    }
