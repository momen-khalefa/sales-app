...
public class DatabaseAccess {
    ...
    //insert customer
    public boolean addCustomer(int id,String customerName, String customerCell, String customerEmail, String customerAddress) {
    ...
    //insert category
    public boolean addCategory(int id,String categoryName) {
    ...
    public ArrayList<HashMap<String, String>> getbills() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                map.put("bill_id", cursor.getString(1));
                map.put("customer_no", cursor.getString(2));
                map.put("currency", cursor.getString(3));
                map.put("date", cursor.getString(4));
                map.put("amounte", cursor.getString(5));
    ...
    public boolean addbills(String cust_no,String currency , String date , String amounte, String note ) {

        ContentValues values = new ContentValues();


        values.put("bill_id", "0");
        values.put("customer_no", cust_no);
        values.put("currency", currency);
        values.put("date", date);
        values.put("amounte", amounte);
    ...
    public boolean updatebill(String Id, String bill_id) {
        ...
        long check = database.update("bills", values, "id=? ", new String[]{Id});
        database.close();
    ...
    public boolean addCheck(String id,String date , String balance , String branch, String bank ,String account) {

        ContentValues values = new ContentValues();


        values.put("id_check", id);
        values.put("date", date);
        values.put("balance", balance);
        values.put("no_branch", branch);
        values.put("no_bank", bank);
        values.put("no_account", account);


        long check = database.insert("checks", null, values);
        database.close();
    ...
    public boolean add_image(String p_id,String image ) {
        ...
        long check = database.insert("p_img", null, values);
        database.close();
    ...
    public boolean delete_all_image() {

        String date = "n/a";
        String balance=null;
        boolean check=false;
        database.delete("p_img",null,null);
    ...
    public String get_image(String id) {
        ...
        String image = "n/a";
        Cursor cursor = database.rawQuery("SELECT * FROM P_img WHERE p_id='" + id + "'", null);
    ...
    public boolean updateCheck(String id,String id_check, String date, String balance , String branch, String bank ,String account) {

        ContentValues values = new ContentValues();
        if(!id_check.equals("")) {
            values.put("id_check", id_check);
        }
        if(!date.equals("")) {
            values.put("date", date);
        }
        ...
        long check = database.update("checks", values, "id=?", new String[]{id});
        database.close();
    ...
    public boolean delete_check() {

        String date = "n/a";
        String balance=null;
        boolean check=false;
         database.delete("checks",null,null);

       // database.close();
        return check;
    }
    public boolean delete_catg() {

        String date = "n/a";
        String balance=null;
        boolean check=false;
        database.delete("product_category",null,null);

        database.close();
        return check;
    }
    public boolean delete_product() {
    ...
    public boolean delete_order() {
        ...
        String balance=null;
        boolean check=false;
        database.delete("order_list",null,null);

        database.close();
        return check;
    }public boolean delete_order_details() {

        String date = "n/a";
        String balance=null;
        boolean check=false;
        database.delete("order_details",null,null);

        database.close();
        return check;
    }

    public boolean delete_units() {

        String date = "n/a";
        String balance=null;
        boolean check=false;
        database.delete("product_weight",null,null);
    ...
    public boolean addunit(int weight_id, String weightUnitId) {

        ContentValues values = new ContentValues();


        values.put("weight_id", weight_id);
        values.put("weight_unit", weightUnitId);
    ...
    public ArrayList<checksModels> getAllChecks() {
        ArrayList<checksModels> product = new ArrayList<>();
        Cursor cursor = database.rawQuery("SELECT * FROM checks", null);
        if (cursor.moveToFirst()) {
            do {
                checksModels map = new checksModels();

                map.setID(cursor.getString(0));
                map.setId_check( cursor.getString(1));
                map.setdate(cursor.getString(2));
                map.setbalance(cursor.getString(3));
                map.setbrancch(cursor.getString(4));
                map.setbank(cursor.getString(5));
                map.setaccount(cursor.getString(6));
                product.add(map);
    ...
    public double getcountAllChecks() {
        double count = 0.0;
        Cursor cursor = database.rawQuery("SELECT * FROM checks", null);
        if (cursor.moveToFirst()) {
            do {
                count+=Double.parseDouble(cursor.getString(3));
    ...
    //insert products
    public boolean addProduct(int id,String productName, int productCode, int productCategory, String productDescription, String productSellPrice, String productSupplier, String productImage, String weightUnitId, String productWeight ,String product_unit2,String product_unit2_price , String product_unit2_code) {
        ...
        values.put("product_unit2", product_unit2);
        values.put("product_unit2_price", product_unit2_price);
        values.put("product_unit2_code", product_unit2_code);
    ...
    public String getProductImage(String productId) {
        ...
        String image = "n/a";
        Cursor cursor = database.rawQuery("SELECT * FROM p_img WHERE p_id='" + productId + "'", null);
    ...
    public int addToCart(String productId, String weight, String weightUnit, String price, float qty) {


        Cursor result = database.rawQuery("SELECT * FROM product_cart WHERE product_id='" + productId + "' and product_weight_unit='"+weightUnit+"'", null);
        if (result.getCount() >= 1) {
    ...
    public int check_in_card(String productId) {
    ...
    public void insertOrder(String orderId, JSONObject obj) {
        ...
        try {
            ...
            Constant.bill_no--;
            values.put("bill_id", ""+Constant.bill_no);
            values.put("bill_status", "0");
    ...
    public ArrayList<HashMap<String, String>> getOrderList() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                map.put(Constant.PRICE, cursor.getString(9));
                map.put(Constant.TABLE_NO, cursor.getString(cursor.getColumnIndex(Constant.TABLE_NO)));
                map.put("bill_id", cursor.getString(11));
                map.put("bill_status", cursor.getString(12));
    ...
    public ArrayList<HashMap<String, String>> getOrderList(String id) {
        ArrayList<HashMap<String, String>> orderList = new ArrayList<>();
        Cursor cursor = database.rawQuery("SELECT * FROM order_list WHERE customer_name='" + id +"' ORDER BY order_id DESC", null);
        if (cursor.moveToFirst()) {
            do {
                HashMap<String, String> map = new HashMap<>();
    ...
    public ArrayList<HashMap<String, String>> getOrderSelect(String id) {
        ArrayList<HashMap<String, String>> orderList = new ArrayList<>();
        Cursor cursor = database.rawQuery("SELECT * FROM order_list WHERE order_id=" + id +" ORDER BY order_id DESC", null);
        if (cursor.moveToFirst()) {
            do {
                HashMap<String, String> map = new HashMap<>();
    ...
    public ArrayList<HashMap<String, String>> getOrder_incoice(String id) {
        ArrayList<HashMap<String, String>> orderList = new ArrayList<>();
        Cursor cursor = database.rawQuery("SELECT * FROM order_list WHERE invoice_id='" + id +"' ORDER BY order_id DESC", null);
        if (cursor.moveToFirst()) {
            do {
                HashMap<String, String> map = new HashMap<>();
    ...
    public ArrayList<HashMap<String, String>> getOrderDetailsList(String orderId) {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                map.put("order_details_id", cursor.getString(0));
                ...
                map.put("product_stauts", cursor.getString(8));
    ...
    public void updateProductImage(String id, String image) {
        ...
        values.put("p_img", image);

        database.update("products", values, "product_id=?", new String[]{id});


    }
    public void updateorderSt(String id, String qty) {

        ContentValues values = new ContentValues();

        values.put("table_no", qty);

        database.update("order_list", values, "order_id=?", new String[]{id});

    }
    public void updatebillid(String id, String qty) {

        ContentValues values = new ContentValues();

        values.put("bill_id", qty);

        database.update("order_list", values, "order_id=?", new String[]{id});

    }
    public void updatebill_stauts(String id, String qty) {

        ContentValues values = new ContentValues();

        values.put("bill_status", qty);

        database.update("order_list", values, "order_id=?", new String[]{id});

    }
    public void updateorderCode(String id, String qty) {

        ContentValues values = new ContentValues();

        values.put("invoice_id", qty);

        database.update("order_list", values, "order_id=?", new String[]{id});

    }
    public void updateorder_details_St(String id, String qty) {

        ContentValues values = new ContentValues();

        values.put("product_stauts", qty);

        database.update("order_details", values, "order_details_id=?", new String[]{id});

    }
    public void updateorder_details_id(String id, String qty) {
    ...
    public String getCustomerBalance(String customer_id) {
    ...
    public double getTotalPrice() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                float qty = Float.valueOf(cursor.getString(5));
    ...
    public String getTotalPrice_order(String id) {


        String totalPrice = "0";

        Cursor cursor = database.rawQuery("SELECT * FROM order_list where invoice_id='"+id+"'", null);
        if (cursor.moveToFirst()) {


                totalPrice = cursor.getString(9);
    ...
    public double totalOrderPrice(String invoiceId) {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                double price = 0;
                if (cursor.getString(5).charAt(cursor.getString(5).length() - 1) == '₪') {
                    price = Double.parseDouble(cursor.getString(5).substring(0,cursor.getString(5).length()-2));
                }
                else{
                    price = Double.parseDouble(cursor.getString(5));
                }
    ...
    public boolean add_shop(String name, String address,String number ,String code ,String image) {

        ContentValues values = new ContentValues();


        values.put("shop_name", name);
        values.put("shop_contact", number);
        values.put("shop_email", code);
        values.put("shop_address", address);
        values.put("tax", image);
    ...
    //get product data
    public ArrayList<HashMap<String, String>> getProducts(String category_id) {
        ArrayList<HashMap<String, String>> product = new ArrayList<>();
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                map.put("p_img", cursor.getString(10));
                map.put("product_unit2", cursor.getString(11));
                map.put("product_unit2_price", cursor.getString(12));
                map.put("product_unit2_code", cursor.getString(13));
    ...
    public ArrayList<HashMap<String, String>> getSearchProducts(String s,String category_id) {
        ArrayList<HashMap<String, String>> product = new ArrayList<>();
        Cursor cursor = database.rawQuery("SELECT * FROM products WHERE product_category = "+category_id+" and  product_name LIKE '%" + s + "%' OR product_code LIKE '%" + s + "%' ORDER BY product_id DESC", null);
        if (cursor.moveToFirst()) {
            do {
                HashMap<String, String> map = new HashMap<>();
